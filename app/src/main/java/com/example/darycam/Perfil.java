...
public class Perfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtconm=findViewById(R.id.txtEmailM);
        txtemailm=findViewById(R.id.txtNombreM);
        txtnomm=findViewById(R.id.txtApellidoM);
        txtapellm=findViewById(R.id.txttelM);
    ...
    private void readuser() {
        String URL = "http://192.168.1.174/darycam/fetchM.php?num_control="+ncontrol;
